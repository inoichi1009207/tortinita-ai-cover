...
正文就是教程(下面从「0. 一句话结果」开始),给下一个想照着做的人。
...
- `docs/` —— 游戏目录侦察报告、Synthesizer V 补录施工单、发布稿件与投稿步骤、
  `audits/` 下是教程经 codex 四轮外审的任务单、回件与逐条处置单。
...
| `tools/` | 本文所有脚本与移植源码 |
| `recon-symphonic-rain.md` | 游戏目录侦察报告 |
